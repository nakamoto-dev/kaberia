          ...
          <div class="relative bg-white rounded-lg shadow">
              ...
              <div class="p-6 space-y-6">
                  <p class="text-base leading-relaxed text-gray-500">
                      ...
                      Till Number:<b>{{ env('TILL_NUMBER') }}</b>
                      
                  </p>
                  <p class="text-base leading-relaxed text-gray-500 ">
                    MPESA TILL:<b>{{ env('TILL_NUMBER') }}</b>
                   </p>
              </div>
              <!-- Modal footer -->
              <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                  <button data-modal-hide="defaultModal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Paid</button>
                  <button data-modal-hide="defaultModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">I`ll Pay Later</button>
              </div>
          </div>
      </div>
  </div>
                    ...
                    <li class="inline-block relative">
                        ...
                        <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
                            ...
                            <a href="login"
                                ...
                                href="register"
                                class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">register
                                </a>
                            ...
                            <div class="items-center flex">
                                <span
                                    class="w-12 h-12 text-sm text-white bg-blueGray-200 inline-flex items-center justify-center rounded-full"><img
                                        ...
                                        src="./img/user.jpg" /></span>
                            </div>
                        </a>
                        <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
                            style="min-width: 12rem;" id="user-responsive-dropdown">
                            <a href="login"
                                class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">Login</a>
                                <a href="register"
                                class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">Register
                                </a>
                                <a href="/"
                                class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700">about
                               </a>
                    ...
                    <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                        ...
                        <li class="items-center">
                            <a class="text-pink-500 hover:text-pink-600 text-xs uppercase py-3 font-bold block"
                                href="home"><i class="fas fa-tv opacity-75 mr-2 text-sm"></i>
                                Dashboard
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="items-center">
                            <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                                href="/user/profile"><i class="fas fa-user-circle text-blueGray-400 mr-2 text-sm"></i>
                                Profile Page</a>
                        </li>
                        @endif
                        <li class="items-center">
        ...
        <div class="relative md:ml-64 bg-blueGray-50">
            <nav
                ...
                <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                    <a class="text-black text-sm uppercase hidden lg:inline-block font-semibold"
            ...
            <!-- Header -->
            <div class="relative bg-sky-100 md:pt-32 pb-32 pt-12">
